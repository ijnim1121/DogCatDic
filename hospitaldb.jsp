...
Object name = request.getParameter("병원명");
Object addr = request.getParameter("사업장소재지(도로명)");
Object pnumber = request.getParameter("전화번호");
Object inst   = request.getParameter("방사선장비 보유현황");
...
while(rs.next()) {
   String name1list = rs.getString("병원명");
   String addrlist = rs.getString("사업장소재지(도로명)");
   String pnumberlist = rs.getString("전화번호");
   String instlist = rs.getString("방사선장비 보유현황");
   out.print(name1list+"\t"+addrlist+"\t"+pnumberlist+"\t"+instlist+"<br>");
}
