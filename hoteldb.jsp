...
Object div   = request.getParameter("구분");
Object name1 = request.getParameter("사업장명칭");
Object addr = request.getParameter("소재지주소");
Object pnumber = request.getParameter("부서전화번호");
...
while(rs.next()) {
   String divlist = rs.getString("구분");
   String name1list = rs.getString("사업장명칭");
   String addrlist = rs.getString("소재지주소");
   String pnumberlist = rs.getString("부서전화번호");
   out.print(divlist+"\t"+name1list+"\t"+addrlist+"\t"+pnumberlist+"<br>");
}
